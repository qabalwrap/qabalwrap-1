...
func (x *HeartbeatPingPong) Reset() {
	*x = HeartbeatPingPong{}
	if protoimpl.UnsafeEnabled {
		mi := &file_message_idl_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HeartbeatPingPong) Descriptor() ([]byte, []int) {
	return file_message_idl_proto_rawDescGZIP(), []int{11}
}
...
var file_message_idl_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x65, 0x22, 0x63, 0x0a, 0x15, 0x48, 0x54, 0x54, 0x50, 0x43, 0x6f, 0x6e, 0x74, 0x65,
	0x6e, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x64, 0x12, 0x23, 0x0a, 0x0d,
	0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x0c, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x65, 0x6e,
	0x74, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x69, 0x64,
	0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x72, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x22, 0x6b, 0x0a, 0x11, 0x48, 0x65, 0x61, 0x72,
...
var file_message_idl_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_message_idl_proto_goTypes = []interface{}{
	...
	(*HTTPContentLinkClosed)(nil),        // 10: qabalwrap1.HTTPContentLinkClosed
	(*HeartbeatPingPong)(nil),            // 11: qabalwrap1.HeartbeatPingPong
}
...
func file_message_idl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_idl_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HTTPContentLinkClosed); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_idl_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
